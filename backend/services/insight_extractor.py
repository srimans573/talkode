...
For rubric_scores: {(
        ...
        "optimization or edge case — do NOT drop to 2 just because the answer was imperfect or incomplete. "
        "Score 2 only when they clearly missed a key component even AFTER the interviewer nudged them toward it. "
        "Score 4 only for genuinely exceptional depth: unprompted trade-off analysis, proactive edge-case coverage. "
